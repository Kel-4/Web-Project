    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="container">
                ...
                <a href="/tambah" class="badge bg-success">Tambah Data</a><br><br>
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $pengunjung->id_buku }}</td>
                            <td>{{ $pengunjung->judul }}</td>
                            <td>{{ $pengunjung->penerbit }}</td>
                            <td>{{ $pengunjung->rak }}</td>
                            <td>{{ $pengunjung->gambar }}</td>
                            <td>
